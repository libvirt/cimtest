...
#
# This test case should test the  RemoveResourcesFromResourcePool service 
# supplied by the RPCS provider. 
# The RemoveResourcesFromResourcePool is used to job to remove resources 
# from a resource pool.
# RemoveResourcesFromResourcePool() details:
# Input 
# -----
# IN -- HostResources --  CIM_LogicalDevice REF[ ]-- The host resources to remove from
# IN -- Pool          --  CIM_ResourcePool REF -- The primordial ResourcePool to remove 
#                                                 resources from
# 
# Output
# ------
# OUT -- Job --  CIM_ConcreteJob REF -- Returned job if started
# OUT -- Error -- String -- Encoded error instance if the operation failed and 
#                           did not return a job.
#
# REVISIT : 
# --------
# As of now the RemoveResourcesFromResourcePool() simply throws an Exception.
